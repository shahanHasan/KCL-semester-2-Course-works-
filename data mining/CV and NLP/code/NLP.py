...
class NLP(object):
    ...
    def Task_1_Question_2(self):
        ...
        # fig = plt.figure("With Stopwords")
        # plt.title("With Stop Words")
        # fd.plot(10,cumulative=False)
        # fig.savefig('NLP_Graphs/freqDistWithStopWords.png', bbox_inches = "tight")
        
        # fig = plt.figure("Without Stopwords")
        # plt.title("Without Stop Words and words <= 2 letters")
        # fd_No_Stopwords.plot(10,cumulative=False)
        # fig.savefig('NLP_Graphs/freqDistWithoutStopWords.png', bbox_inches = "tight")
